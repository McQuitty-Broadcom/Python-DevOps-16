...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS16 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS16 --type LNK --os --maxrc 0 --sn 1 --cb`
...
`zowe jobs submit data-set "CUST016.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-16.git`
